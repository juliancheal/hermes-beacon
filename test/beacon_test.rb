...
describe Hermes::Beacon do
  ...
  describe 'Distance' do
    it "should return a distance of 1 when rssi & power are equal" do
      ...
      scan.calculate_distance_from_beacon.floor.must_equal 1
    end

    it "should return a distance of 2 when rssi is double power" do
      scan = Hermes::Beacon::ScanItem.new("uuid", "major", "minor", -59, -65)
      scan.calculate_distance_from_beacon.floor.must_equal 2
    end
  end
